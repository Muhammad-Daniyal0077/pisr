...
<footer>
            ...
            <div class=" col-sm-12 footer-content-box">
                ...
                <div class="col-sm-4 ms-2">
                    ...
                    <iframe
                        ...
                        width="100%" height="200" style="border: 0px;" allowfullscreen=""
    ...
    <style>
        ...
        a:hover i.facebook {
            color: #0746f5;
            /* Slightly lighter blue for Facebook */
        }

        a:hover i.twitter {
            color: #0796ed;
            /* Lighter blue for Twitter */
        }

        a:hover i.instagram {
            color: #e36607;
            /* Slightly darker pink for Instagram */
        }
