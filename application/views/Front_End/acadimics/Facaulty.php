                    ...
                    <div style="width: 1210px;">
                        <div class="inner-container">
                            <div class="row justify-content-center dropdown-content-custom ">
                                <?php foreach ($male_faculty as $faculty): ?>
                                    <div class="col-md-4 mb-4">
                                        <div class="card text-center shadow-lg rounded border-0">
                                            <img src="<?php echo base_url(); ?>uploads/faculty_images/<?php echo $faculty->faculty_img; ?>" class="card-img-top rounded-circle img-fluid" alt="Faculty Image">
                                            <div class="card-body">
                                                <h5 class="card-title text-info"><?php echo $faculty->faculty_name; ?></h5>
                                                <p class="card-text text-muted"><?php echo $this->db->get_where('designation_type', array('id' => $faculty->faculty_designation))->row()->staff_type; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                ...
                <div class="vc_column">
                    <div style="width: 1210px; margin-left:-550px">
                        <div class="inner-container">
                            ...
                            <?php foreach ($female_faculty as $faculty): ?>
                                    <div class="col-md-4 mb-4">
                                        <div class="card text-center shadow-lg rounded border-0">
                                            <img src="<?php echo base_url(); ?>uploads/faculty_images/<?php echo $faculty->faculty_img; ?>" class="card-img-top rounded-circle img-fluid" alt="Faculty Image">
                                            <div class="card-body">
