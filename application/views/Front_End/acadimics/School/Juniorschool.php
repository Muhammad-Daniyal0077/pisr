...
<div class="pic">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(https://pisr.org/v2/wp-content/uploads/2021/06/Untitled-design1.png);">
        ...
        <div class="container">
            <h1 class="animated-title">Junior School</h1>
    ...
    <div class="container">
        <div class="row event-body-content">
            <div class="col-sm-12 events-full-box ">
                <h2 class="text-center">PISR Junior-School
                </h2>
                <div class="events-single-box">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="<?php echo base_url(); ?>asset/images/downloads/pre1.jpg" alt="not" class="img-responsive-principle">
                        </div>

                        <div class="col-sm-6 event-info img-fluid">
                            <p class="div-sm-7 event-info">
                                Our pre-school program, which encompasses classes from PG Nursery KG through grade 1, is designed with the primary goal of nurturing the leaders of tomorrow through a combination of high-quality education and the development of crucial social skills.
                        
                                We are committed to instilling 21st Century skills in our young learners by creating engaging and interactive lessons that incorporate hands-on activities and project-based learning. Through a variety of weekly activities and competitions, we prepare our students for success in the world beyond our walls, ensuring that they emerge as confident leaders and exemplary individuals.
                            </p>
                            <p class="div-sm-7 event-info">
                                Through STEAM activities, both students and teachers are able to engage in a dynamic learning experience that promotes the achievement of lesson objectives while fostering a love for learning. Following the esteemed Oxford Curriculum, we deliver the necessary knowledge to our students in a fun and engaging manner, utilizing a range of activities and expertly crafted lesson plans to foster a love for learning and academic success.
                            </p>
                        </div>
