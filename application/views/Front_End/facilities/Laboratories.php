...
<style>
    ...
    * {
    ...
    .vc-hoverbox-wrapper {
        height: 650px;
        perspective: 1000px;
        /* Adjusted perspective for better 3D effect */
        width: 660px;
        text-align: center;
        ...
        /* Slightly more shadow for depth */
    }
    ...
    .vc-hoverbox-back {
        ...
        /* Semi-transparent white for better readability */
        display: flex;
        align-items: center;
        justify-content: center;
        text-align: center;
    ...
    .center-paragraph {
        ...
        /* Center alignment */
        margin-left: 400px;
        /* To ensure it is centered within the container */
    }
    ...
    .center-heading {
        font-size: 3rem;
        color: #2c3e50;
        /* Dark blue-grey color for the heading */
        font-weight: 700;
        text-transform: uppercase;
        letter-spacing: 2px;
        position: relative;
    ...
    .center-paragraph {
        font-size: 1.8rem;
        color: #34495e;
        /* Slightly lighter color for the paragraph */
        line-height: 1.8;
        max-width: 1030px;
