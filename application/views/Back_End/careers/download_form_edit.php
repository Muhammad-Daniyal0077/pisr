<div class="pagetitle">
	<h1>Download Form Edit</h1>
	<nav>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="#">Home</a></li>
			<li class="breadcrumb-item active">Download Form Edit</li>
		</ol>
	</nav>
</div><!-- End Page Title -->
						...
						<form class="row g-3" enctype="multipart/form-data" method="post"
							...
							<div class="col-sm-12 col-md-12">
								...
								<select class="form-control" id="head"  name="head" required>
									<option value="Admission Information" <?php echo ($rows->head == 'Admission Information') ? 'selected' : ''; ?>>Admission Information</option>
									<option value="Forms" <?php echo ($rows->head == 'Forms') ? 'selected' : ''; ?>>Forms</option>
									<option value="Acadimics" <?php echo ($rows->head == 'Acadimics') ? 'selected' : ''; ?>>Acadimics</option>
								</select>
							</div>
							<div class="col-md-12">
